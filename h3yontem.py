...
# Rotaları çizme
folium.PolyLine(locations=[(coord[1], coord[0]) for coord in route_coords_1], color='red', weight=4, opacity=0.7).add_to(m)  # Alternatif 1: Araba Yolu
folium.PolyLine(locations=[(coord[1], coord[0]) for coord in route_coords_2], color='yellow', weight=4, opacity=0.7).add_to(m)  # Alternatif 2: Dağ Yolu
